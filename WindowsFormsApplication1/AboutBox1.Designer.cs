namespace WindowsFormsApplication1
{
    partial class AboutBox1
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.labelProductName.Text = "缩水过滤分式一体化";
            ...
            this.textBoxDescription.Text = "创建筛选库界面，如果勾选一定的数字后进行行勾选，会清除掉原先的勾选记录，所以请先进行行勾选。\r\n\r\n当进行数据生成跟筛选操作时，可能由于数据量比较大，软件会假死，" +
    "请等待其处理完毕即可恢复正常。";
            // 
            // okButton
            // 
